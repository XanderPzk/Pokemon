...
public class Pokemon {
    ...
    public void applyLocalEdits(PokemonController.UpdatePokemonRequest request) {
        boolean hasLocalName = request.getLocalName() != null;
        boolean hasRegion = request.getRegion() != null;
        boolean hasTags = request.getInternalTags() != null;
        ...
        if (hasLocalName) {
            Optional<String> localName = request.getLocalName();
        ...
        if (hasRegion) {
            this.region = request.getRegion().orElse(null);
        }
        if (hasTags) {
            this.internalTags = validateTags(request.getInternalTags().orElse(null));
        }
    }
