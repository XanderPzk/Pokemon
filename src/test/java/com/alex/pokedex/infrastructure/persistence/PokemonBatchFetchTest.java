...
import com.alex.pokedex.pokemon.PokemonController;
...
class PokemonBatchFetchTest {
    ...
    void seedPokemon() {
        for (int id = 1; id <= 5; id++) {
            ...
            request.setLocalName(Optional.of("Local " + id));
            request.setRegion(Optional.of("Region " + id));
            request.setInternalTags(Optional.of(List.of("tag-" + id)));
